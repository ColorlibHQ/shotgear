    ...
    <div class="col-full">
        <div class="featured">
            ...
            <div class="featured__column featured__column--big">
                <?php 
                $term = shotgear_opt( 'shotgear_featured_cat' );
                ...
                ?>
                    <div class="entry" <?php echo shotgear_inline_bg_img( get_the_post_thumbnail_url() ); ?>>
                        
                        <div class="entry__content">
                            <?php 
                            if( shotgear_featured_post_cat() ){
                                echo '<span class="entry__category">'.shotgear_featured_post_cat().'</span>';
                            }
                            ?>
