...
// image default alt
if( !function_exists( 'shotgear_img_default_alt' ) ){
	function shotgear_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'shotgear_img_tag' ) ){
	function shotgear_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = shotgear_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'shotgear_anchor_tag' ) ){
	function shotgear_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'shotgear_heading_tag' ) ){
	function shotgear_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'shotgear_paragraph_tag' ) ){
	function shotgear_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'shotgear_other_tag' ) ){
	function shotgear_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'shotgear_button_element ' ) ){
	function shotgear_button_element( array $args ){
