...
----------------------------------------*/
class shotgear_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('shotgear_instagram_photo',esc_html__('[ Shotgear ] Intagram Photo','shotgear'),array(
			'description' => esc_html__('Shotgear Instagram Photo Widget','shotgear'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'shotgear');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'shotgear'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'shotgear'); ?></label>
...
if(!function_exists('shotgear_instagram_widgets')):
	function shotgear_instagram_widgets(){
		register_widget('shotgear_instagram_photo');
	}
	add_action('widgets_init','shotgear_instagram_widgets');
endif;
