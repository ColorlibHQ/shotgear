(function( $ , api){
    ...
    api.section( 'shotgear_fof_section' , function( section ){
    ...
    // Customizer about page redirect
    api.section( 'shotgear_about_section' , function( section ){
    ...
    api.section( 'shotgear_blog_section' , function( section ){
    ...
    api.section( 'shotgear_contact_section' , function( section ){

        section.expanded.bind( function( isExpanded ){

            // Customizer contact form seclector 
            var customshortcodefield = $('#customize-control-shotgear_contact_custom_formshortcode'),
                selector = $('#_customize-input-shotgear_contact_formshortcode');
    ...
    // General section
    api.section( 'shotgear_general_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $preloader      = $('#shotgear_preloader_toggle'),
                $preloaderbg    = $( '#customize-control-shotgear_preloader_bg_color' ),
                $preloadercolor = $( '#customize-control-shotgear_preloader_color' );
            ...
            var $backtotop          = $( '#shotgear_backtotop_btn' ),
                $backtotopbg        = $( '#customize-control-shotgear_backtotop_btn_bg_color' ),
                $backtotophoverbg   = $( '#customize-control-shotgear_backtotop_btn_hover_bg_color' );
    ...
    // Footer section
    api.section( 'shotgear_footer_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $widget_toggle      = $('#shotgear_footer_widget_toggle');
